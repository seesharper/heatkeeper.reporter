...
await new ReporterHost()
        ...
        .AddReporter(new RTL433Reporter().AddSensor(Sensors.Acurite606TX).AddSensor(Sensors.AcuriteTower).AddSensor(Sensors.FineOffsetWH2).WithPublishInterval(new TimeSpan(0, 10, 0)))
